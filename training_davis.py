...
print('\nrunning use ', model_st + ' on davis dataset')
davis_train_atom = 'data/processed/davis_train_atom.pt'
davis_test_atom = 'data/processed/davis_test_atom.pt'
davis_train_clique = 'data/processed/davis_train_clique.pt'
davis_test_clique = 'data/processed/davis_test_clique.pt'


if ((not os.path.isfile(davis_train_atom)) or (not os.path.isfile(davis_test_atom)) or (not os.path.isfile(davis_train_clique)) or (not os.path.isfile(davis_test_clique))):
    print('please run dataloader_davis.py to prepare data in pytorch format!')
else:
    train_data = TestbedDataset(root='data', dataset='davis_train')
